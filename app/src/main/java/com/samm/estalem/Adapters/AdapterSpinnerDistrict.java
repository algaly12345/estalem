...
public class AdapterSpinnerDistrict extends  RecyclerView.Adapter<AdapterSpinnerDistrict.MyViewHolder> implements SpinnerAdapter {

    private List<District> contacts;
    private Context context;

    public AdapterSpinnerDistrict(List<District> contacts, Context context) {
        this.contacts = contacts;
        this.context = context;
    }

    @Override
    public AdapterSpinnerDistrict.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_item_spinner_state, parent, false);
        return new AdapterSpinnerDistrict.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(AdapterSpinnerDistrict.MyViewHolder holder, int position) {
        final District contact =contacts.get(position);
